...
- Адрес моста в сети eth = [0x013538B357A4c2CcdE81E2318e5cA0560c171C8e](https://goerli.etherscan.io/address/0x013538B357A4c2CcdE81E2318e5cA0560c171C8e)
- Адрес WSIBR в сети eth = [0xA72d39Ac1c5BB0abc1A044741947ACC44a23CCe5](https://goerli.etherscan.io/address/0xA72d39Ac1c5BB0abc1A044741947ACC44a23CCe5)
...
Выплаты гардианам могут считаться в процентах, могут быть с коэффециентами активности гардиана и много чего ещё, но пока фиксированно
![img_3.png](img_3.png)
![img_4.png](img_4.png)

_И сам мост==provider тоже получает плату как процент от перевода или как сейчас 0.001_

#### увидеть свопы по [ссылке](http://92.255.109.253:9011/api/swaps?limit=20)
...
### СНАЧАЛА по кнопке CONNECT подключить ММ на фронте
...
Во втором поле Вам надо вписать количество средств в ETH, которое вы хотите перевести в другую сеть, включая комиссию. Она вычтется сама при переводе. Установлено правило в минимальном количестве средств для перевода
   ...
   - `Ethereum` → `Siberium` = 0.01 ETH

   - `Siberium` → `Ethereum` = 0.01 SIBR
